...
if __name__ == '__main__':
    ...
    schema_path = "/home/bedrockbilling/Deveolpment/zX12/schema/837p.json" #Change this to your schema path
    schema_name = "837p"
    # Load schema
    ...
    schema_path = "/home/bedrockbilling/Deveolpment/zX12/schema/837i.json" #Change this to your schema path
    schema_name = "837i"
    # Load schema
    load = loadSchema(schema_path, schema_name)
    if load != 0:
